...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    var mode = req.query.mode ? parseInt(req.query.mode) : 0; //0 -normal, 1 - force invalidate, 2 - cache only
    ...
    if (method.toUpperCase() === 'GET' && options.cache && options.cacheMaxAge > 0 && !(mode === 1)) {
